...
namespace WindowsFormsApplication1
{
    class G:Figure
    {
        ...
        public override void rotate()
        {
            ...
            {
                case 0:
                    LeftPoint = new Point(LeftPoint.X, LeftPoint.Y + Width);
                    break;
                case 1:
                    LeftPoint = new Point(LeftPoint.X - 2 * Width,LeftPoint.Y);
                    break;
                case 2:
                    LeftPoint = new Point(LeftPoint.X + Width,LeftPoint.Y);
                    break;
                case 3:
                    LeftPoint = new Point(LeftPoint.X + Width, LeftPoint.Y - Width);
                    break;
